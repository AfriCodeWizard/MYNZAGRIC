...
export const successStories: SuccessStory[] = [
  ...
  },
  {
    ...
    fullDescription: "Carlos Martinez's success story demonstrates how premium grafted seedlings can revolutionize fruit farming. After years of disappointment with traditional mango varieties that produced small, low-quality fruits, Carlos invested in MINZAGRIC's premium grafted mango seedlings (Kent, Keitt, and Tommy Atkins varieties) along with our precision drip irrigation system. His plantation now serves global markets.",
