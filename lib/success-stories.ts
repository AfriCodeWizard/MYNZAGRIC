...
export const successStories: SuccessStory[] = [
  {
    ...
    fullDescription: "Jackline Mwangi's journey from a small-scale farmer to a successful agribusiness owner is a testament to the transformative power of climate-smart farming solutions. Starting with minimal savings, she invested in our solar irrigation kit, which became the cornerstone of her agricultural venture.",
    challenge: "Jackline faced significant challenges in accessing reliable water sources for her strawberry farm. The inconsistent rainfall patterns and lack of irrigation infrastructure threatened her crop yields and income stability. Additionally, she struggled to find reliable buyers who would offer fair prices for her produce.",
    solution: "We provided Jackline with a comprehensive solar irrigation kit that included solar-powered pumps and efficient drip irrigation systems. Beyond the equipment, we facilitated direct connections with buyers in the market, ensuring she received competitive rates for her high-quality strawberry produce.",
    results: [
  ...
  },
  {
    ...
    shortDescription: "To address the water scarcity issue, Kavita implemented strategic measures. He installed solar-powered pumps, acquired a dam liner for efficient water storage, and invested in our irrigation systems.",
    fullDescription: "Kavita Ndolo transformed his farming operation by addressing critical water management challenges. Through strategic investments in solar-powered irrigation and water storage solutions, he created a sustainable farming system that thrives even in water-scarce conditions.",
    challenge: "Kavita's farm was located in a region experiencing severe water scarcity. The lack of reliable water sources during dry seasons severely limited his ability to grow fruits and vegetables. Traditional water collection methods were inefficient and time-consuming, leaving little time for actual farming activities.",
    solution: "Kavita implemented a comprehensive water management solution that included solar-powered pumps to extract water from available sources, a dam liner for efficient water storage during rainy seasons, and our specialized irrigation systems designed specifically for growing fruits and vegetables. This integrated approach ensured year-round water availability.",
    results: [
