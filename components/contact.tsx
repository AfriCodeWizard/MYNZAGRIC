        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-[calc(5xl+5px)] mx-auto">
            <div className="bg-white rounded-[25px] shadow-[20px_22px_44px_rgba(0,0,0,0.1)] relative">
              {/* Contact Form */}
              <div className="p-6 md:p-8 pr-28 md:pr-40">
                <div className="mb-6">
                  <h3 className="text-3xl md:text-4xl font-semibold text-gray-900 mb-2">Contact Us</h3>
                  <p className="text-gray-600 text-sm">
                    Feel free to contact us any time. We will get back to you as soon as we can!
                  </p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-4 max-w-[calc(100%-340px)] md:max-w-[calc(100%-380px)]">
                  <input
                    type="text"
                    name="name"
                    required
              ...
              <div className="absolute right-0 top-0 bottom-0 w-16 md:w-20 bg-gradient-to-br from-green-600 to-green-700 rounded-tr-[25px] rounded-br-[25px] flex items-center justify-center">
                <div className="flex flex-col gap-4 md:gap-5 items-center justify-center p-3">
                      <a
